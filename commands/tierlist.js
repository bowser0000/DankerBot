module.exports = {
    name: 'tierlist',
    description: 'Sends the tier list of the specified Smash game. Shortcuts are m, smelee, sillym, sm, b, brawl-, bm, b-, pm, u, 5.',
    aliases: ['tl'],
    ...
    execute(message, args) {
        ...
        switch(args[0].toLowerCase()) {
            ...
            case 'u':
            case '5':
                message.channel.send('This tier list is not an official tier list. It was made by averaging the tier lists from pro players. Last updated: 03/12/2019', {file: 'tierlists/ultimatetl.png'});
                break;
            default:
